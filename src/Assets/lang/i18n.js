...
const resources = {
    en: {
        translation: {
            ...
            'Phone Crawler': 'Phone Number Crawler',
            'Phone Crawler Description': 'A distributed crawler that collects & filters premium phone numbers (Viettel/VNPT/Vietnamobile). Backend in FastAPI + PostgreSQL, deployed on Kubernetes; this React UI is embedded as a live demo.<br/><br/><b>Anonymous visitors can watch live (read-only); job control requires an admin token.</b>',
            'System Flow Board': 'System Flow Board',
            'NexusTI Flow': 'NexusTI Flow',
            'Sample Flow': 'Sample Flow',
            'Open full screen': 'Open full screen',
            'Open Demo': 'Open Demo',
            'Summary': 'Summary',
            'Phone Crawler Tab Desc': 'Distributed crawler for premium phone numbers — FastAPI + PostgreSQL backend with a live React dashboard.',
            'NexusTI Flow Tab Desc': 'My current company: a debt-collection & lending microservice platform mapped as an interactive, editable diagram.',
            'Sample Flow Tab Desc': 'A sample e-commerce microservice architecture you can drag, rewire and edit live.',
            'System Flow Description': 'An interactive board for sketching the system architectures I worked on — microservices talking over REST/gRPC, async Kafka events, Keycloak IAM, PostgreSQL & Redis. Drag components from the palette, wire them up, rename and re-type connections.<br/><br/><b>Fully editable in your browser; every change is saved locally and can be reset to the samples anytime. Export/Import diagrams as JSON.</b>',
    ...
    vi: {
        translation: {
            ...
            'Phone Crawler': 'Crawler Số Điện Thoại',
            'Phone Crawler Description': 'Crawler phân tán thu thập & lọc số điện thoại đẹp (Viettel/VNPT/Vietnamobile). Backend viết bằng FastAPI + PostgreSQL, deploy trên Kubernetes; giao diện React này được nhúng làm demo chạy thật.<br/><br/><b>Khách ẩn danh có thể xem trực tiếp (chỉ xem); thao tác điều khiển job cần admin token.</b>',
            'System Flow Board': 'Sơ Đồ Hệ Thống',
            'NexusTI Flow': 'Sơ đồ NexusTI',
            'Sample Flow': 'Sơ đồ mẫu',
            'Open full screen': 'Mở toàn màn hình',
            'Open Demo': 'Mở Demo',
            'Summary': 'Tóm tắt',
            'Phone Crawler Tab Desc': 'Crawler phân tán lọc số điện thoại đẹp — backend FastAPI + PostgreSQL, dashboard React chạy thật.',
            'NexusTI Flow Tab Desc': 'Công ty hiện tại của mình: nền tảng microservice thu hồi nợ & cho vay, vẽ thành sơ đồ tương tác sửa được.',
            'Sample Flow Tab Desc': 'Sơ đồ kiến trúc microservice e-commerce mẫu — kéo-thả, nối lại, sửa trực tiếp.',
            'System Flow Description': 'Bảng vẽ tương tác để phác họa kiến trúc các hệ thống mình từng làm — microservices giao tiếp qua REST/gRPC, sự kiện bất đồng bộ Kafka, IAM bằng Keycloak, PostgreSQL & Redis. Kéo component từ palette, nối dây, đổi tên và đổi loại kết nối.<br/><br/><b>Chỉnh sửa hoàn toàn ngay trên trình duyệt; mọi thay đổi lưu cục bộ và reset về mẫu bất cứ lúc nào. Xuất/Nhập sơ đồ dạng JSON.</b>',
